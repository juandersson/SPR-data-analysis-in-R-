...
# Create vectrors for the concentration variable and corresponding Beq values.The first value should be 0 
# for both variables 
...
plot(c,Beq, ylim = c(0,300),xlab="[analyte]", ylab="Beq")
      ...
      #choose which range of X-values are most suitable to visualize the data being analysed.   
